...
export class HomeComponent implements OnInit, AfterViewInit, OnDestroy {
          ...
          next: (res: any) => {
            if (res) {
              ...
              this.router.navigate([
                `${
                  this.communityDetails.pageType === 'community' ? 'Visionaries' : 'Occult Topics'}`,
              ]);
            }
          },
          error: (error) => {
  ...
  openAlertMessage(): void {
    ...
    modalRef.componentInstance.confirmButtonLabel = 'Ok';
    modalRef.componentInstance.cancelButtonLabel = 'Cancel';
    modalRef.componentInstance.message = `Videos on ConscienceExplorers.com home are limited to 5 Minutes!
